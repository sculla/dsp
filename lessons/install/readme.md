...
>> I installed Python 3 because it is the most up to date version and EOL for 2 is nigh. Having started learning python in version 3, i still havent learned the differences between the two. 
